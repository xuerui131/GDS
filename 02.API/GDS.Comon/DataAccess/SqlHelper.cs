...
namespace GDS.Comon
{
    ...
    public sealed class SqlHelper
    {
        ...
        public static DataTable ExecuteGetTable(string connectionString, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            SqlCommand cmd = new SqlCommand();
            ...
            {
                bool mustCloseConnection = false;
                PrepareCommand(cmd, conn, null, cmdType, cmdText, commandParameters, out mustCloseConnection);
        ...
        public static void SqlBulkCopyByDatatable(string TableName, DataTable dt, string connectionString, List<string> column = null)
        {
            using (SqlBulkCopy sqlbulkcopy = new SqlBulkCopy(connectionString))
            {
                ...
                try
                {
                    ...
                    {
                        if (column != null && column.Contains(dt.Columns[i].ColumnName))
                        {
        ...
        //sourcecolumns, destcolumns长度一致对应
        public static void SqlBulkCopyByDatatable(string TableName, DataTable dt, string connectionString, List<string> sourcecolumns, List<string> destcolumns)
        {
            using (SqlBulkCopy sqlbulkcopy = new SqlBulkCopy(connectionString))
            {
                sqlbulkcopy.BulkCopyTimeout = 500;
                try
                {
                    ...
                    if (sourcecolumns != null)
                    {
                        ...
                        {
                            sqlbulkcopy.ColumnMappings.Add(column, destcolumns[i]);
    ...
    public abstract class SqlHelperDB
    {
        ...
        /// <summary>
        /// this method will add a input sql parameter
        /// </summary>
        ...
        /// <summary>
        /// this method will add a Input SqlParameter
        /// </summary>
        ...
        /// <summary>
        /// this method will add a Output SqlParameter
        /// </summary>
        /// <param name="ParamName">Name of parameter.</param>
        /// <param name="DbType">Parameter type.</param>
        /// <param name="Size">Parameter size.</param>
        ...
        /// <summary>
        /// this method will create a SqlParameter
        /// </summary>
        /// <param name="ParamName">Name of parameter.</param>
        /// <param name="DbType">Parameter type.</param>
        /// <param name="Size">Parameter size.</param>
        ...
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>an int representing the number of rows affected by the command</returns>
        public static int ExecuteTranNonQuery(string connectionString, CommandType cmdType, string cmdText)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                conn.Open();
        ...
        public static List<T> GetProcedureDataByColumnsLst<T>(string conn, string pro, params SqlParameter[] commandParameters)
        {
            DataTable tb = SqlHelper.ExecuteGetTable(conn, CommandType.StoredProcedure, pro, commandParameters);
            return DataConvert<T>(tb);
        }
        /// <summary>
        ...
        public static DataSet ExecuteGetDataSet(string connectionString, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandTimeout = 120;
            using (SqlConnection conn = new SqlConnection(connectionString))
        ...
        /// <param name="columns">表的列的数组</param>
        /// <param name="tableName">表名</param>
        /// <param name="where">查询条件</param>
        /// <returns></returns>
        public static DataTable GetDataByColumns(string conn, string[] columns, string tableName, string where)
        {
            if (columns == null || columns.Length == 0)
            {
                throw new Exception("columns不能为空或者元素个数为0");
            }
            string cols = " ";
            ...
            return SqlHelper.ExecuteGetTable(conn, CommandType.Text, sql, null);
        }
        ...
        /// </summary>
        /// <param name="conn">数据库连接字符串</param>
        /// <param name="columns">表的列</param>
        /// <param name="tableName">表名</param>
        /// <param name="where">查询条件</param>
        /// <returns></returns>
        public static DataTable GetDataByColumns(string conn, string column, string tableName, string where)
        {
            if (string.IsNullOrEmpty(column))
            {
                throw new Exception("column字段不能为空");
            }
            string[] columns = new string[] { column };
            return GetDataByColumns(conn, columns, tableName, where);
        }

        public static T GetDataByColumns<T>(string conn, string column, string tableName, string where)
        {
            if (string.IsNullOrEmpty(column))
            {
                throw new Exception("column字段不能为空");
            ...
            return GetDataByColumns<T>(conn, cols, tableName, where);
        }

        public static T GetDataByColumns<T>(string conn, string[] columns, string tableName, string where)
        {
            DataTable tb = GetDataByColumns(conn, columns, tableName, where);
            if (tb.Rows.Count > 0)
            {
                return DataConvert<T>(tb.Rows[0]);
            }
            else
            {
                return default(T);
        ...
        public static List<T> GetDataByColumnsLst<T>(string conn, string column, string tableName, string where)
        {
            if (string.IsNullOrEmpty(column))
            {
                throw new Exception("column字段不能为空");
            ...
            string[] cols = new string[] { column };
            return GetDataByColumnsLst<T>(conn, cols, tableName, where);
        }
        public static IList<T> GetDataByColumnsIList<T>(string conn, string column, string tableName, string where)
        {
            if (string.IsNullOrEmpty(column))
            {
                throw new Exception("column字段不能为空");
        ...
        public static List<T> GetDataByColumnsLst<T>(string conn, string[] columns, string tableName, string where)
        {
            using (DataTable tb = GetDataByColumns(conn, columns, tableName, where))
            {
                return DataConvert<T>(tb);
            }
        }

        public static T GetDataByColumns<T>(string conn, string sql, params SqlParameter[] commandParameters)
        {
            using (DataTable tb = SqlHelper.ExecuteGetTable(conn, CommandType.Text, sql, commandParameters))
            {
        ...
        public static List<T> GetDataByColumnsLst<T>(string conn, string sql, params SqlParameter[] commandParameters)
        {
            using (DataTable tb = SqlHelper.ExecuteGetTable(conn, CommandType.Text, sql, commandParameters))
            {
                return DataConvert<T>(tb);
        ...
        public static IList<T> GetDataByColumnsIList<T>(string conn, string sql, params SqlParameter[] commandParameters)
        {
            using (DataTable tb = SqlHelper.ExecuteGetTable(conn, CommandType.Text, sql, commandParameters))
            {
                return DataConvert<T>(tb);
        ...
        /// <returns></returns>
        public static string PropertiesToString(Type type, List<string> removeIds, Dictionary<string, string> modifyp)
        {
            Dictionary<string, string> modifyp2 = new Dictionary<string, string>();
            if (modifyp != null)
            {
                foreach (var c in modifyp.Keys)
                {
                    modifyp2.Add(c.ToLower(), modifyp[c]);
                }
            }
            ...
            if (removeIds != null)
            {
                ...
                {
                    removeIds[i] = removeIds[i].ToLower();
                }
            }
            ...
            foreach (var c in ps)
            {
                ...
                if (removeIds == null || !removeIds.Contains(lname))
                {
                    if (modifyp2.ContainsKey(lname))
                    {
                        name = modifyp2[lname];
                        sb.Append(name + ",");
                    }
        ...
        /// <returns></returns>
        public static DataSet GetDataSet(string sql, string constr)
        {
        ...
        public static SqlParameter[] ObjectToSqlParameters(object obj, string[] removeKey)
        {
            //System.
            ...
            if (removeKey != null)
            {
                foreach (var c in removeKey)
                {
                    lstRemove.Add(c.ToLower());
                }
            }
            foreach (var c in ps)
            {
                if (lstRemove.Contains(c.Name.ToLower()))
                {
                    continue;
                }
                object value = c.GetValue(obj, null);
                if (c.PropertyType == typeof(int) || c.PropertyType == typeof(int?))
                {
                    lst.Add(CreateSqlParameter(c.Name, SqlDbType.Int, value));
                }
                else if (c.PropertyType == typeof(long) || c.PropertyType == typeof(long?))
                {
                    lst.Add(CreateSqlParameter(c.Name, SqlDbType.BigInt, value));
                }
                else if (c.PropertyType == typeof(string))
                {
                    lst.Add(CreateSqlParameter(c.Name, SqlDbType.VarChar, value));
                }
                else if (c.PropertyType == typeof(bool) || c.PropertyType == typeof(bool?))
                {
                    lst.Add(CreateSqlParameter(c.Name, SqlDbType.Bit, value));
                }
                else if (c.PropertyType == typeof(byte[]))
                {
                    lst.Add(CreateSqlParameter(c.Name, SqlDbType.Binary, value));
                }
                else if (c.PropertyType == typeof(DateTime) || c.PropertyType == typeof(DateTime?))
                {
                    lst.Add(CreateSqlParameter(c.Name, SqlDbType.DateTime, value));
                }
                else if (c.PropertyType == typeof(decimal?) || c.PropertyType == typeof(decimal) || c.PropertyType == typeof(float)
                    || c.PropertyType == typeof(float?) || c.PropertyType == typeof(double) || c.PropertyType == typeof(double?))
                {
                    lst.Add(CreateSqlParameter(c.Name, SqlDbType.Decimal, value));
                }
                else if (c.PropertyType == typeof(System.Guid) || c.PropertyType == typeof(Guid?))
                {
                    lst.Add(CreateSqlParameter(c.Name, SqlDbType.UniqueIdentifier, value));
                }
            }
            return lst.ToArray();
        }

        public static SqlParameter[] ObjectToSqlParameters(object obj)
        {
            return ObjectToSqlParameters(obj, null);
        }

        private static SqlParameter CreateSqlParameter(string name, SqlDbType dbType, object value)
        {
            if (!name.StartsWith("@"))
            {
                name = "@" + name;
            ...
            SqlParameter sp = new SqlParameter(name, dbType);
            sp.Value = value;
            return sp;
        }
    }

...
namespace GDS.BLL
{
    public class SupplierInfoBLL
    {

        ISupplierInfoDao<SupplierInfo> dal;
        public SupplierInfoBLL()
        {
            dal = new ImplSupplierInfo() { };
        }
        /// <summary>
        /// 获取分页数据
        /// </summary>
        ...
        /// <returns></returns>
        public List<SupplierInfo> GetDataByPage(PageRequest preq)
        {
            return dal.GetDataByPage<SupplierInfo>(preq);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<SupplierInfo> GetDataAll()
        {
            return dal.GetDataAll<SupplierInfo>();
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public SupplierInfo GetDataById(int id)
        {
            return dal.GetDataById<SupplierInfo>(id);
        }
        ...
        public ResultEntity<int> DeleteDataById(int id)
        {
            ...
            try
            {
                var repResult = dal.DeleteDataById<SupplierInfo>(id);
        ...
        public ResultEntity<int> FalseDeleteDataByIds(int[] Ids)
        {
            ...
            {
                int IntRet = 0;
                var repResult = dal.FalseDeleteDataByIds<SupplierInfo>(Ids);
        ...
        // 添加
        public ResultEntity<int> InsertSupplierInfo(SupplierInfo uie)
        {
            ResultEntity<int> result;
            ...
            {
                int IntRet = 0;
                var repResult = dal.Insert<SupplierInfo>(uie);
                if (repResult != null)
                {
        ...
        // 修改
        public ResultEntity<int> UpdateSupplierInfo(SupplierInfo uie)
        {
            ResultEntity<int> result;
            ...
            {
                int IntRet = 0;
                var repResult = dal.Update<SupplierInfo>(uie);

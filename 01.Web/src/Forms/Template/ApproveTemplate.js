...
class ApproveTemplate extends React.Component {
    state={
        templatePhases: [],
        projectTypeList: [],
        templateInfo: {}
    ...
    onReject()
    {
        ...
        axios.get(`${Constants.APIBaseUrl}/Template/UpdateStatus?Id=${projectId}&Status=2`, {
            headers: { 'Content-Type': 'application/json' }
        })
            .then(res => {
                this.setState(
    ...
    render() {
        ...
        let btnStartStyle = {width:'150px', marginRight:'25px', marginTop:'10px', marginBottom:'10px'}
        return (
            <div>
